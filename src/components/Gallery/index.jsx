...
export class Gallery extends Component {
  render() {
    var images = [
      ...
      {
        src: "https://images.blacktomato.com/2015/02/Tamil-Nadu.jpg?auto=compress%2Cformat&ixlib=php-3.3.0&s=48a8eb03ac0798d16a3ecbaa4234891b",
        sub: "Madurai",
      },
      {
        src: "https://assets.cntraveller.in/photos/60c07ef28fc45ba3917d99f0/master/pass/chennai-tamil-nadu-lockdown-1366x768.jpg",
        sub: "Chennai City",
      },
      {
        src: "https://gos3.ibcdn.com/india-tamil-nadu-149339162619o.jpeg",
        sub: "Temple",
      },
      {
        src: "https://english.madhyamam.com/h-upload/2020/09/14/689546-1600x960689472-suriya-1492020.webp",
        sub: "Surya",
      },
      {
        src: "https://images.indianexpress.com/2021/09/master-vijay-1200.jpg",
        sub: "Vijay",
      },
      {
        src: "https://www.buzinessbytes.com/wp-content/uploads/2021/09/MAHESH-BABU-NET-WORTH-2021.jpg",
        sub: "Mahesh",
      },
    ];
    var settings = {
    ...
    return (
      <div>
        <LightRoomComponent images={images} settings={settings} />
      </div>
    );
  }
}
